        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button aria-label="Button" type="button" className="flex items-center space-x-3 bg-black hover:bg-gray-900 text-white px-6 py-3 rounded-xl transition-colors">
