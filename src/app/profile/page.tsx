...
import { UserCircle, Lock, ArrowRight, ShieldCheck, ShoppingBag, Clock, CreditCard, ChevronRight, User } from 'lucide-react'
          ...
          <div className="bg-white/80 backdrop-blur-2xl p-10 rounded-[2.5rem] shadow-2xl border border-white/40 text-center relative overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.button 
                ...
                whileHover={{ scale: 1.02 }} 
                className="bg-[#BCE334] text-black px-10 py-4 rounded-2xl font-bold uppercase text-xs tracking-[0.2em] shadow-lg shadow-[#BCE334]/20 flex items-center justify-center gap-2"
              >
              ...
              <button 
                ...
                className="bg-black text-[#BCE334] px-10 py-4 rounded-2xl font-bold uppercase text-xs tracking-[0.2em] shadow-lg flex items-center justify-center gap-2"
              >
                Logout
              </button>
            </div>
