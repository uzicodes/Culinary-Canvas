...
import { PlusCircle, Utensils, LayoutDashboard, LogOut, ArrowRight } from "lucide-react";
        ...
        >
          ...
          <div className="bg-[#F7FBE7]/90 backdrop-blur-2xl p-8 rounded-[2.5rem] shadow-2xl border border-white">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {/* THE POWER: Add New Item */}
              <Link href="/admin/add-item">
                <motion.div 
                  whileHover={{ scale: 1.02 }} 
                  className="p-6 bg-black rounded-[2rem] flex flex-col items-center gap-3 cursor-pointer group shadow-md"
                >
              ...
              {/* Manage Menu: Redirects to all-items */}
              <Link href="/all-items">
                <motion.div 
                  whileHover={{ scale: 1.02 }} 
                  className="p-6 bg-white rounded-[2rem] border border-gray-100 flex flex-col items-center gap-3 cursor-pointer shadow-sm group hover:border-[#BCE334] transition-colors"
                >
