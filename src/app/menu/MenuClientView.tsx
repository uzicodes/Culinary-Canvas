...
export default function MenuClientView({ initialMenuItems }: { initialMenuItems: MenuItem[] }) {
  const groupedMenu = initialMenuItems.reduce((acc, item: MenuItem) => {
  ...
  return (
    <main className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="mt-16 text-center bg-gray-900 rounded-3xl p-10 text-white">
        ...
        <Link href="/all-items">
          <button aria-label="Button" type="button" className="bg-[#BCE334] text-black px-10 py-3 rounded-full font-bold uppercase text-sm hover:scale-105 transition-transform">
