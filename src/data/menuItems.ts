...
const menuItems: MenuItem[] = [
  ...
  { id: 78, name: 'Haleem', description: 'Traditional meat and lentil stew', price: 450, category: 'pakistani', image: '/items/pakistani/haleem.png' },
  { id: 79, name: 'Seekh Kebab', description: 'Grilled spiced minced meat skewers', price: 400, category: 'pakistani', image: '/items/pakistani/seekh_kebab.png' },
  { id: 80, name: 'Chapli Kebab', description: 'Flat spiced meat patties from Peshawar', price: 420, category: 'pakistani', image: '/items/pakistani/chapli_kebab.png' },
  { id: 81, name: 'Nalli Nihari', description: 'Premium slow-cooked beef shank with bone marrow and spices', price: 650, category: 'pakistani', image: '/items/pakistani/nihari.png' },
